 ...
 * @param props.width - card width; omitted keeps the shared 244px default.
 * @returns anchor wrapper with the conditional portaled card.
 */
export function HoverCard({
  anchor, content, openDelayMs = 500, disabled = false,
  copyText, copyLabel = '复制', copiedLabel = '复制成功', width,
}: {
  anchor: ReactNode
  content: ReactNode
  openDelayMs?: number
  ...
  /** Card width; omitted keeps the shared 244px default. */
