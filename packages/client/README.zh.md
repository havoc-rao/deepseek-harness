...
| [`ui-workspace/`](ui-workspace/README.zh.md) | 提供工作区选择与创建界面（logo 插件填充的行槽位所在）。 |
| [`workspace-logo/`](../experimental/workspace-logo/README.zh.md) | 用 logo 图片、选择器与持久化 Host 提交填充工作区行的图标/菜单/悬浮卡槽位。 |
