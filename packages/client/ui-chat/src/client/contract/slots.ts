...
import type { MarkdownFileMentions, UserTextReferenceOwner } from '@deepseek-ai/dsh-client-ui-primitives'
...
/**
 * Slot-backed inline reference renderer for sent user text; returning
 * undefined declines the token and keeps the shipped chip.
 */
export type RenderMessageReference = (owner: UserTextReferenceOwner) => ReactNode | undefined
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  ...
  interface SlotMap {
    ...
    /**
     * Replacement renderer for one decorated reference token in sent user
     * text. The chain's selectors route by owner; an entry declines tokens it
     * does not own, and an all-decline (or empty) chain keeps the shipped
     * inline chip.
     */
    'conversation.message.reference': { kind: 'chain'; scope: 'session'; owner: UserTextReferenceOwner }
    /**
