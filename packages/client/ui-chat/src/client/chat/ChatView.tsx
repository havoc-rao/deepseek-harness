...
import type { ChatViewSlotProps, OpenFileOptions, RenderMessageReference } from '../contract/slots.ts'
...
export function ChatView({
  ...
  const renderMessageReference = useCallback<RenderMessageReference>(
    owner => renderSlotChain('conversation.message.reference', owner) ?? undefined,
    [renderSlot],
  )
