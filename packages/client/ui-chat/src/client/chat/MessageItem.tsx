...
function UserStyleBubble({
  content, renderMessageImages, renderMessageReference, actions, pending = false, echo = false,
  referenceLabels = [], skillNames = [], previewAttachments, references, t,
}: {
  content: readonly unknown[]
  renderMessageImages: ChatNodeOwnerProps['renderMessageImages']
  renderMessageReference: ChatNodeOwnerProps['renderMessageReference']
    ...
    >
      <div className={css.userStack}>
        ...
        {showBubble && <div className={css.bubble}>
          {projectUserText(text, referenceLabels, skillNames, 'skill', references, renderMessageReference)}
 ...
 */
export function PendingSubmissionBubble({ submission, renderMessageImages, renderMessageReference, t }: {
...
export const UserMessageNodeView = memo(function UserMessageNodeView({
  node, renderMessageImages, renderMessageReference, openFile, openSkill, t,
