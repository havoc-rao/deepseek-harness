...
export const zh = {
  ...
  'hover.copied': '已复制',
  'hover.recentInputs': '输入源',
  'hover.recentOutputs': '输出源',
  'hover.recentFilesMore': '其余 {n} 个文件',
  'hover.view.list': '列表',
  'hover.view.tree': '树形',
...
export const en = {
  ...
  'hover.copied': 'Copied',
  'hover.recentInputs': 'Input sources',
  'hover.recentOutputs': 'Output sources',
  'hover.recentFilesMore': '{n} more files',
  'hover.view.list': 'List',
  'hover.view.tree': 'Tree',
  'date.ymd': '{y}-{m}-{d}',
  'time.now': 'now',
  'time.minutes': '{n}min',
  'time.hours': '{n}h',
