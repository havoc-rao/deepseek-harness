 ...
 * a plain stylesheet (for example `@xterm/xterm/css/xterm.css`) inlines its
 * minified text, and `x.css?inline` exports compiled text for a plugin-owned
 * lifecycle effect. Either way the css text auto-injects a
 * <style data-plugin="<id>"> tag at factory execution (the loader removes
 * plugin-owned tags on unload). The virtual loaders register each real
 ...
 */
export const INLINE_SAFE = /^@deepseek-ai\/dsh-(host-apiproxy|file-reference|session|llm|tools|brand|terminal-protocol)(\/|$)/
