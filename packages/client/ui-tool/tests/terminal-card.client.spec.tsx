...
// The terminal render intent on the web side, core surfaces: the chat tool
// row's expanded body (GenericToolCard / BashRow) and the details panel's
// Output section. The pure terminalCardModel derivation lives in the
// ui-tool-kit package.
