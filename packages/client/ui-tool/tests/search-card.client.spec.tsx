...
// The search render intent on the web side, core surfaces: the chat tool row
// (GenericToolCard's fallback body and SearchRow, both composing the shared
// ToolRow with the search card collapsed by default) and the details panel's
// Output section (resident, full height). The keyed registration under both
// grep and glob is pinned here too. The pure searchCardModel derivation lives
// in the ui-tool-kit package.
...
import { CHAT_SEARCH_MAX_LINES } from '@deepseek-ai/dsh-client-ui-tool-kit/client'
