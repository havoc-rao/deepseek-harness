...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'sidebar.workspaces.workspaceHoverIcon',
    kind: 'single',
    scope: 'root',
    summary: 'Workspace hover-card header (occupant: card-sized logo; empty: title-only).',
    doc: 'Workspace hover-card header (occupant: card-sized logo; empty: title-only).',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      '@havocrao/dsh-client-workspace-logo WorkspaceHoverLogo',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.workspaceHoverIcon\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.workspaceHoverIcon\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:96',
  },
  {
    key: 'sidebar.workspaces.workspaceIcon',
    kind: 'single',
    scope: 'root',
    summary: 'Workspace row leading cell (occupant: logo image; empty: folder glyph).',
    doc: 'Workspace row leading cell (occupant: logo image; empty: folder glyph).',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      '@havocrao/dsh-client-workspace-logo WorkspaceLogoCell',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.workspaceIcon\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.workspaceIcon\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:92',
  },
  {
    key: 'sidebar.workspaces.workspaceMenu',
    kind: 'single',
    scope: 'root',
    summary: 'Workspace row ellipsis-menu extension (occupant: logo-add entry; empty: none).',
    doc: 'Workspace row ellipsis-menu extension (occupant: logo-add entry; empty: none).',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      '@havocrao/dsh-client-workspace-logo WorkspaceLogoMenuEntry',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.workspaceMenu\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.workspaceMenu\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-workspace/src/client/contract/slots.ts:94',
  },
  {
    ...
    occupants: [
      ...
      'client-ui-toolview-file-mutation FileMutationRow key \'edit\'',
      'client-ui-toolview-file-mutation FileMutationRow key \'write\'',
