...
| [`@omdsh-dev/dsh-code-finder`](https://github.com/omdsh-dev/DSH-code-finder) | MIT |
...
| [`@xterm/addon-canvas`](https://github.com/xtermjs/xterm.js/tree/master/addons/addon-canvas) | MIT |
