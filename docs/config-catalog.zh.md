...
- `@deepseek-ai/dsh-client-ui-tool-kit`（[`packages/client/ui-tool-kit/src/index.ts`](../packages/client/ui-tool-kit/src/index.ts)）
- `@deepseek-ai/dsh-client-ui-toolview-file-mutation`（[`packages/client/ui-toolview-file-mutation/src/index.ts`](../packages/client/ui-toolview-file-mutation/src/index.ts)）
...
- `@havocrao/dsh-client-workspace-logo`（[`packages/experimental/workspace-logo/src/index.ts`](../packages/experimental/workspace-logo/src/index.ts)）
