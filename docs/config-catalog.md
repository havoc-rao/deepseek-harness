...
Source: [`packages/hooks/hooks-claude-code/src/index.ts:49`](../packages/hooks/hooks-claude-code/src/index.ts)
...
Source: [`packages/host/open-in-app/src/index.ts:66`](../packages/host/open-in-app/src/index.ts)
