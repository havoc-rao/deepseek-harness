...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-terminal': { kind: 'none', reason: 'Browser-side terminal pane; registers nothing model-facing.' },
  ...
  'packages/host/terminal-web': { kind: 'none', reason: 'The browser terminal WebSocket bridge registers nothing model-facing.' },
  ...
  'packages/util/terminal-protocol': { kind: 'none', reason: 'Wire-protocol library; nothing here reaches a model request.' },
