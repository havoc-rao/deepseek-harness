...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-tool-kit': { kind: 'none', reason: 'Browser-side Tool-row presentation library; renders logged calls without changing model context.' },
  'packages/client/ui-toolview-file-mutation': { kind: 'none', reason: 'Browser-side keyed Tool-row plugin; renders logged calls without changing model context.' },
  ...
  'packages/experimental/workspace-logo': { kind: 'none', reason: 'Browser-side workspace surface occupant; render chrome only, nothing model-facing.' },
